...
| `GET` | `/api/v1/daily-brief` | خواندنی | خروجیِ اجراییِ روزانه‌ی §۳۸ — از دفتر کل، بدون اجرای موتور. |
...
| `GET` | `/api/v1/operator-load` | خواندنی | فرصت‌های زنده به‌ازای مسئول؛ بی‌مسئول‌ها در سطلِ جدا. |
