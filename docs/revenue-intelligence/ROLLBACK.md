...
2. بازگردانی پشتیبان **اختیاری** است، نه الزامی. استثنا: مهاجرت ۱۷
   (`order_line_identity`) کلیدِ خطوطِ فاکتوردار را بازنویسی و تکراری‌های
   میان‌دسته‌ای را ادغام می‌کند؛ پیش از ارتقا به آن نسخه، `sqlite3.backup`
   بگیرید تا اگر لازم شد دفترِ پیش از ادغام را داشته باشید.
