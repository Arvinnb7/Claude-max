...
سپس در داشبورد: داده را بارگذاری کنید (یا «داده‌ی نمونه» را بزنید) → نگاشت ستون‌ها را
تأیید کنید → به صفحات شاخص‌ها، سگمنت‌بندی، پیش‌بینی، تارگت، استراتژی هوش مصنوعی و
خروجی گزارش بروید.
